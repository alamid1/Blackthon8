...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@blackthon1"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('- ها ضلعي يمك بلاك ثون اخدمني بشي | @SpAnei')
...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | 𝙎𝙊𝙐𝙍𝘾𝙀 𝘽𝙇𝘼𝘾𝙆𝙏𝙃𝙊𝙉 ')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@T_R_5BOT', 'جاري التجميع بواسطة | 𝙎𝙊𝙐𝙍𝘾𝙀 𝘽𝙇𝘼𝘾𝙆𝙏𝙃𝙊𝙉 ')
        channel_entity = await sython.get_entity(bot_usernamee)
        await sython.send_message('@T_R_5BOT', '/start')
        await asyncio.sleep(5)
        msg0 = await sython.get_messages('@T_R_5BOT', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sython.get_messages('@T_R_5BOT', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await sython(ImportChatInviteRequest(bott))
                msg2 = await sython.get_messages('@T_R_5BOT', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
...
async def _(event):
      await event.reply("""
༗ 𝐖𝐄𝑳𝐂𝐎𝐌𝐄 𝐓𝐎 𝙎𝙊𝙐𝙍𝘾𝙀 𝘽𝙇𝘼𝘾𝙆𝙏𝙃𝙊𝙉  🦅
༗ 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐍 𝐓𝐄𝑳𝐄𝐆𝐑𝐀𝐌
༗ 𝐂𝐇𝐀𝐍𝐍𝐄𝑳 𝐒𝐎𝐔𝐑𝐂𝐄 : @blackthon1
"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""ᴛʜᴇ ᴅᴇᴠ ꜱᴏᴜʀᴄᴇ : @SpAnei"""
)
